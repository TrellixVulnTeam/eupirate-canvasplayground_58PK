(function (global, factory) {
	...
	var iconColors = {
	    ...
	    disabled: colors.soap600,
	    hover: colors.licorice500,
	    inverse: colors.frenchVanilla100,
	    standard: colors.licorice200,
	};
	...
	function getBrandingColors() {
	  ...
	  Object.keys(colors)
	    ...
	    .reduce((result, name) => {
	      const obj = {};
	      obj[name.replace('500', '')] = colors[name];
	      return {
	        ...result,
	        ...obj,
	      };
	...
	function getHue(color) {
	  const hue = Object.keys(colors).filter(
	  ...
	  if (hue.length > 0) {
	    return hue.reduce((result, name) => {
	      const obj = {};
	      obj[name.replace(/^[a-zA-Z]*/g, '')] = colors[name];
	      return {
	        ...result,
	        ...obj,
	      };
	...
	function getColor(color) {
	  ...
	  const foundColor = colors[findColor];
	...
	function pickForegroundColor(
	  background,
	  darkColor = colors.blackPepper600,
	  lightColor = colors.frenchVanilla100
	) {
	...
	const categories = {
	  ...
	  accent: {
	    ...
	    prefix: 'wd-accent',
	    colorables: {
	      [colorableKeys.color]: getColorableFn(['.color-500'], colors.blueberry500),
	    },
	  },
	  applet: {
	    path: 'applet',
	    ...
	    colorables: {
	      [colorableKeys.color]: attrVal => {
	        ...
	        return {
	          '.color-100': colors.frenchVanilla100,
	          '.color-200': hue[200],
	          '.color-300': hue[300],
	          '.color-400': hue[400],
